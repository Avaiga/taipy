...
For further information, on installing Taipy on a Conda Environment or from source, <br /> please refer to the [Installation Guide](https://docs.taipy.io/en/latest/installation/).<br />
