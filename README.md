...
### <div align="left"> Taipy is an open-source Python library for building your web application front-end & back-end.<div align="left"> Turns data and AI algorithms into production-ready web applications in no time. </div>
