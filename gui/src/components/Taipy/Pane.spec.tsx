...
describe("Pane Component", () => {
    ...
    it("renders nothing when value is false", async () => {
        const { queryAllByRole } = render(
            <HelmetProvider>
                <Pane pageId="pageId" value={false} />
            </HelmetProvider>
        );
    ...
    it("displays the right info for class", async () => {
        const { getByRole } = render(
            <HelmetProvider>
                <Pane pageId="pageId" value={true} className="taipy-pane" />
            </HelmetProvider>
        );
        const elt = getByRole("presentation");
    ...
    it("displays the default value", async () => {
        const { getByRole } = render(
            <HelmetProvider>
                <Pane pageId="pageId" defaultValue="true" value={undefined as unknown as boolean} />
            </HelmetProvider>
        );
    ...
    it("is disabled", async () => {
        ...
        render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane pageId="pageId" value={true} active={false} closeAction="testCloseAction" />
                </HelmetProvider>
    ...
    it("is enabled by default", async () => {
        ...
        render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane pageId="pageId" value={true} closeAction="testCloseAction" />
                </HelmetProvider>
            </TaipyContext.Provider>
        );
        const elt = document.querySelector(".MuiBackdrop-root");
    ...
    it("is enabled by active", async () => {
        ...
        render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane pageId="pageId" value={true} active={true} closeAction="testCloseAction" />
                </HelmetProvider>
            </TaipyContext.Provider>
        );
        const elt = document.querySelector(".MuiBackdrop-root");
    ...
    it("persistent is disabled", async () => {
        ...
        const { getByRole } = render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane pageId="pageId" value={true} active={false} persistent={true} closeAction="testCloseAction" />
                </HelmetProvider>
            </TaipyContext.Provider>
        );
        const elt = document.querySelector(".MuiBackdrop-root");
    ...
    it("dispatch a well formed message on close", async () => {
        ...
        const { getByText } = render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane id="testId" pageId="pageId" value={true} closeAction="testCloseAction" />
                </HelmetProvider>
            </TaipyContext.Provider>
        );
        const elt = document.querySelector(".MuiBackdrop-root");
    ...
    it("dispatch a well formed message on close for persistent", async () => {
        ...
        const { getByRole } = render(
            <TaipyContext.Provider value={{ state, dispatch }}>
                <HelmetProvider>
                    <Pane id="testId" pageId="pageId" value={true} persistent={true} tp_varname="varname" />
                </HelmetProvider>
            </TaipyContext.Provider>
        );
        const elt = document.querySelector(".MuiBackdrop-root");
