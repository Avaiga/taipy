...
describe("Selector Component", () => {
    ...
    it("uses the class", async () => {
        ...
        const elt = getByText("Item 1");
        expect(elt.parentElement?.parentElement?.parentElement?.parentElement?.parentElement).toHaveClass("taipy-selector");
    })
    ...
    it("dispatch a well formed message", async () => {
        ...
        userEvent.click(elt2);
        expect(dispatch).toHaveBeenLastCalledWith({name: "varname", payload: {value: ["id1", "id3"]}, propagate: true, "type": "SEND_UPDATE_ACTION"});
    });
    //filter
