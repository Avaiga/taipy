...
class table extends shared {
    ...
    /**
     * Column name indexed property (style[column name]) where the value is a style class name, a local function or lambda which should take at least a row of data as first parameter (with column_name optional string second parameter) and return a string value.<br>Without index, the function define style at the row level.
     * @type {column_indexed(str)}
     */
    style;
}
