...
# Function to create a bar graph for a given district
def bar_graph(district):
   df = dataset

   # Filter the data for the specified district
...
# Function to create an overlayed chart for a given district
...
# Function to create a radar chart for a given district
...
# Function to create a pie chart for a given district
...
# Function to create a bubble chart for the entire dataset
...
# Function to create a treemap for the entire dataset
def treemap_whole():
   df = dataset
...
# Function to create a bar graph for the entire dataset
def bar_graph_whole():
   df = dataset
...
# Function to create an overlayed chart for the entire dataset
