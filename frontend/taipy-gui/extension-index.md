...
*updateVars* and *updateVarName*, that are used to ensure a proper update of variable changes. The function {@link getUpdateVar | getUpdateVar()} uses that property.
