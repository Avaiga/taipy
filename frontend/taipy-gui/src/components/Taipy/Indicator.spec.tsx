...
describe("Indicator Component", () => {
    ...
    it("displays the right info for string", async () => {
        const { getByText } = render(
            <Indicator value={12} defaultValue={12} defaultDisplay="Display" className="taipy-indicator" />,
        );
        const elt = getByText("Display");
    ...
    it("displays the default value", async () => {
        const { getByText } = render(
            <Indicator defaultDisplay="Display" display={undefined as unknown as string} defaultValue={12} />,
        );
        getByText("Display");
    });
