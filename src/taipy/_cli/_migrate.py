...
def _migrate_scenario(scenario: Dict, data: Dict) -> Dict:
    ...
    scenario["additional_data_nodes"] = None
...
def _migrate_datanode(datanode: Dict) -> Dict:
    ...
    datanode["owner_id"] = datanode.get("owner_id", None)
