...
class Gui:
    ...
    def _set_broadcast(self, broadcast: bool = ...): ...
    def _del_broadcast(self) -> None: ...
    ...
    def _set_css_file(self, css_file: t.Optional[str] = ...): ...
