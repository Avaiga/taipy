...
from .config import Config, ConfigArgument, _Config
...
class Gui:
    ...
    def _get_config(self, name: ConfigArgument, default_value: t.Any) -> t.Any:
    ...
    def add_page(
        ...
        if isinstance(page, str):
            ...
            raise Exception(
                f'Argument "page" is invalid for page name "{name if name != Gui.__root_page_name else "/"}.'
            )
        # Init a new page
        new_page = _Page()
