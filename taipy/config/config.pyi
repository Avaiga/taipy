...
class Config:
    ...
    def set_default_data_node_configuration(
        ...
        Parameters:
            ...
            validity_period (Optional[timedelta]): The duration since the last edit date for which
                the data node can be considered up-to-date. Once the validity period has passed,
                the data node is considered stale and relevant tasks will run even if they are
                skippable (see the
                [Task configs page](../../../userman/task-orchestration/scenario-config.md#from-task-configurations)
                for more details).
        ...
        **properties,
        ...
        Parameters:
            ...
            validity_period (Optional[timedelta]): The duration since the last edit date for which the data node can be
                ...
                [Task configs page](../../../userman/task-orchestration/scenario-config.md#from-task-configurations) for
                more details).
                If *validity_period* is set to None, the data node is always up-to-date.
            **properties (dict[str, any]): A keyworded variable length list of additional arguments.
