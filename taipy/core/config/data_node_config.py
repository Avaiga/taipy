...
class DataNodeConfig(Section):
    ...
    _OPTIONAL_AWS_S3_OBJECT_PARAMETERS_PROPERTY = "aws_s3_object_arguments"
    ...
    def _configure_s3_object(
        ...
        **properties,
        ...
        if aws_s3_object_arguments is not None:
            properties[cls._OPTIONAL_AWS_S3_OBJECT_PARAMETERS_PROPERTY] = aws_s3_object_arguments
