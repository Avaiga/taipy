...
def test_get_set_tasks():
    ...
    pipeline_2 = Pipeline("xyzzy", {}, [task_3, task_4], PipelineId("p2"))
    scenario_1 = Scenario("scenario_1", [pipeline_1, pipeline_2], {}, ScenarioId("s1"))
    assert scenario_1._get_set_tasks() == {task_1, task_2, task_3, task_4}

    task_5 = Task("waldo", {}, print, id=TaskId("t5"))
    pipeline_3 = Pipeline("dlugh", {}, [task_1, task_2, task_3], PipelineId("p3"))
    pipeline_4 = Pipeline("xyzzyx", {}, [task_5, task_4], PipelineId("p4"))
    scenario_2 = Scenario("scenario_2", [pipeline_3, pipeline_4], {}, ScenarioId("s2"))
    assert scenario_2._get_set_tasks() == {task_1, task_2, task_3, task_4, task_5}
...
def test_get_sorted_tasks():
    ...
    #       |           |      |
    # s2 ---             ---> s4 ---> t4 ---> s7
    assert assert_two_sorted_list_of_tasks(scenario._get_sorted_tasks(), [[task_1], [task_2, task_4], [task_3]])
    ...
    #       |           |      |
    # s2 ---             ---> s4 ---> t4 ---> s7
    assert assert_two_sorted_list_of_tasks(scenario._get_sorted_tasks(), [[task_2, task_1], [task_4, task_3]])
    ...
    # t2 ---> s5
    # s8 ---> t5
    assert assert_two_sorted_list_of_tasks(scenario._get_sorted_tasks(), [[task_5, task_2, task_1], [task_4, task_3]])
    ...
    task_3 = Task("waldo", {}, print, [data_node_4], None, id=TaskId("t3"))
    task_4 = Task("fred", {}, print, [data_node_4], [data_node_5], TaskId("t4"))
    task_5 = Task("bob", {}, print, [data_node_7], [data_node_4], None, TaskId("t5"))
    pipeline_1 = Pipeline("plugh", {}, [task_4, task_1, task_3], PipelineId("p1"))
    pipeline_2 = Pipeline("hulgh", {}, [task_2, task_3], PipelineId("p2"))
    ...
    data_node_6 = DataNode("quuz", Scope.PIPELINE, "s6")
    data_node_7 = DataNode("corge", Scope.PIPELINE, "s7")
    data_node_8 = DataNode("corge", Scope.PIPELINE, "s8")
    ...
    task_3 = Task("waldo", {}, print, [data_node_4], None, id=TaskId("t3"))
    task_4 = Task("fred", {}, print, [data_node_4], [data_node_5], TaskId("t4"))
    task_5 = Task("bob", {}, print, [data_node_8], [data_node_4], TaskId("t5"))
    pipeline_1 = Pipeline("plugh", {}, [task_4, task_1, task_3], PipelineId("p1"))
    pipeline_2 = Pipeline("hulgh", {}, [task_2, task_3], PipelineId("p2"))
    pipeline_3 = Pipeline("qulqh", {}, [task_5, task_4], PipelineId("p3"))
    ...
    #  p3  s8 ---> t5 ---> s4 ---> t4 ---> s7
    #  p4  s4 ---> t4 ---> s7
    print(scenario._get_sorted_tasks())
    print([[task_5, task_2, task_1, task_4], [task_3]])
    # assert assert_two_sorted_list_of_tasks(scenario._get_sorted_tasks(), [[task_5, task_2, task_1, task_4], [task_3]])
