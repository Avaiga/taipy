...
def test_scenario_getitem():
    ...
    assert Config.scenarios[scenario_id].task_and_data_node_configs == scenario.task_and_data_node_configs
    assert Config.scenarios[scenario_id].tasks_and_data_nodes == scenario.tasks_and_data_nodes
    assert Config.scenarios[scenario_id].task_and_data_node_configs == scenario.tasks_and_data_nodes
...
def test_clean_config():
    ...
    assert scenario1_config.tasks_and_data_nodes == scenario1_config.task_and_data_node_configs == []
    ...
    assert scenario2_config.tasks_and_data_nodes == scenario2_config.task_and_data_node_configs == []
