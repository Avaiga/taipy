...
def _test_default_scenario_config(scenario_config: ScenarioConfig):
    ...
    assert scenario_config.tasks == set()
    assert scenario_config.task_configs == set()
    assert scenario_config.additional_data_nodes == set()
    assert scenario_config.additional_data_node_configs == set()
