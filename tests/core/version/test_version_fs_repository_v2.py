...
class TestVersionFSRepository:
    def test_save_and_load(self):
        repo = _VersionFSRepository()
        expected = _Version(id="foo", config=Config._applied_config)
        repo._save(expected)

        assert expected == repo._load("foo")
    ...
    def test_get_set_latest_version(self):
        repo = _VersionFSRepository()
    ...
    def test_get_set_development_version(self):
        repo = _VersionFSRepository()
    ...
    def test_get_set_production_version(self):
        repo = _VersionFSRepository()
    ...
    def test_delete_production_version(self):
        repo = _VersionFSRepository()
