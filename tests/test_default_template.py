...
def test_multipage_gui_template(tmpdir):
    cookiecutter(
        ...
        extra_context={
            "Application root folder name": "foo_app",
            "How many pages and name of the pages?": "3",
        },
    )
...
def test_multipage_gui_template_with_page_names(tmpdir):
    ...
    cookiecutter(
        ...
        extra_context={
            "Application root folder name": "foo_app",
            "How many pages and name of the pages?": "3 name_1 name_2 name_3",
        },
    )
    ...
    cookiecutter(
        ...
        extra_context={
            ...
            "How many pages and name of the pages?": "3 name_1 ",
        },
    )
    ...
    cookiecutter(
        ...
        extra_context={
            ...
            "How many pages and name of the pages?": "3 name_1 name_2 name_3 name_4 name_5",
        },
    )
