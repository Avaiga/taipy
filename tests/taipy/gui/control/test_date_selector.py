...
def test_date_selector_md_1(gui: Gui, helpers):
    ...
    expected_list = ["<DateSelector", 'defaultDate="2020-12-', 'tp_varname="date"', "date={date}"]
...
def test_date_selector_md_2(gui: Gui, helpers):
    ...
    expected_list = ["<DateSelector", 'defaultDate="2020-12-', 'tp_varname="date"', "date={date}", "withTime={true}"]
    helpers.test_control_md(gui, md_string, expected_list)
