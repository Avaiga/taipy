...
def test_date_md_1(gui: Gui, helpers):
    ...
    md_string = "<|{date}|date|>"
    expected_list = ["<DateSelector", 'defaultDate="2020-12-', 'updateVarName="TaipyDate_date"', "date={TaipyDate_date}"]
...
def test_date_md_2(gui: Gui, helpers):
    ...
    expected_list = ["<DateSelector", 'defaultDate="2020-12-',
                     'updateVarName="TaipyDate_date"', "date={TaipyDate_date}", "withTime={true}"]
    helpers.test_control_md(gui, md_string, expected_list)
