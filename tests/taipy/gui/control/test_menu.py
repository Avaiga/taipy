...
def test_menu_md(gui: Gui, helpers):
    ...
    expected_list = ["<MenuCtl", 'className="taipy-menu"', 'defaultLov="[&quot;Item 1&quot;, &quot;Item 2&quot;, &quot;Item 3&quot;, &quot;Item 4&quot;]"',
                     'lov={TaipyLov_lov}', 'tp_onAction="on_menu_action"', 'tp_updatevars="lov=TaipyLov_lov"']
