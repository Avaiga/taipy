...
def test_sending_messages_in_group(gui: Gui, helpers):
    ...
    assert gui._get_user_data()._get_all_scopes()[sid].name == "World!"  # type: ignore
    assert gui._get_user_data()._get_all_scopes()[sid].btn_id == "button1"  # type: ignore
    ...
    assert gui._get_user_data()._get_all_scopes()[sid].name == "Monde!"
    assert gui._get_user_data()._get_all_scopes()[sid].btn_id == "button2"  # type: ignore
