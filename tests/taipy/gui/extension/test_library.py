...
class MyLibrary(ElementLibrary):
    ...
    elts = [Element("testinput", "value", [ElementAttribute("value", PropertyType.dynamic_string, "Fred"), ElementAttribute("multiline", PropertyType.boolean, False)], "Input")]
...
def test_lib_input_md(gui: Gui, test_client, helpers):
    ...
    expected_list = ["<Input", 'className="testlib-testinput"', 'multiline={true}', 'defaultValue=""', 'value={tpec_TpExPr_val_TPMDL_0}']
