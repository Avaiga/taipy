...
def test_file_download_file_builder(gui: Gui, test_client, helpers):
...
def test_file_download_path_builder(gui: Gui, test_client, helpers):
    gui._bind_var_val(
...
def test_file_download_any_file_builder(gui: Gui, test_client, helpers):
