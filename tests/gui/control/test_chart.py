...
def test_chart_md_1(gui: Gui, helpers, csvdata):
    ...
    gui.bind_var_val("subplot_layout", {"grid": {"rows": 1, "columns": 2, "subplots": [["xy", "x2y"]], "roworder": "bottom to top"}})
    ...
    expected_list = ["<Chart", 'refresh={csvdata__refresh}', 'selected0={selected_indices}', 'selected1={selected_indices}', 'height="100%"', 'layout="{&quot;grid&quot;: {&quot;rows&quot;: 1, &quot;columns&quot;: 2, &quot;subplots&quot;: [[&quot;xy&quot;, &quot;x2y&quot;]], &quot;roworder&quot;: &quot;bottom to top&quot;}}"', 'rangeChange="range_change"', 'tp_updatevars="selected0=selected_indices;selected1=selected_indices"', 'tp_varname="csvdata"', 'value={csvdata}', 'width="100%"']
