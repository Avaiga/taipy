...
def test_create_pipeline_entity():
    input = InMemoryDataSource.create("foo", Scope.PIPELINE, "data")
    output = InMemoryDataSource.create("bar", Scope.PIPELINE, "other data")
...
def test_check_consistency():
    ...
    data_source_3 = InMemoryDataSource.create("foo", Scope.PIPELINE, "bar")
    ...
    input_4 = InMemoryDataSource.create("foo", Scope.PIPELINE, "bar")
    output_4 = InMemoryDataSource.create("foo", Scope.PIPELINE, "bar")
...
def test_to_model():
    input = InMemoryDataSource.create("input", Scope.PIPELINE, "this is some data")
    output = InMemoryDataSource.create("output", Scope.PIPELINE, "")
