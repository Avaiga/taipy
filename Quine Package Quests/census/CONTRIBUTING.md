# Contributing to Census

Welcome! We appreciate your interest in contributing to the **Census** project. Follow the steps below to make your contribution:
...
2. **Clone Your Fork**:
   ...
   ```bash
   git clone https://github.com/yourusername/from_taipy_census.git
   ```
